...
import MarkedScheduleTab from './MarkedScheduleTab'
    ...
    return (
        <Card>
            <TabContext value={activeTab}>
                ...
                >
                    <Tab value='attendance' label='Điểm danh học sinh' icon={<i className='ri-checkbox-circle-line' />} iconPosition='start' sx={{ minHeight: 'unset', py: 2 }} />
                    <Tab value='marked_schedule' label='Quản lý ca kiểm tra' icon={<i className='ri-file-list-3-line' />} iconPosition='start' sx={{ minHeight: 'unset', py: 2 }} />
                </TabList>
                <TabPanel value='attendance' sx={{ p: 0 }}>
                    <CardHeader
                ...
                <TabPanel value='marked_schedule' sx={{ p: 0 }}>
                    <MarkedScheduleTab />
                </TabPanel>
            </TabContext>
        </Card>
